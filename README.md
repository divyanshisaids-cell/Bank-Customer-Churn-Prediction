...
**KPI cards:** Overall Churn Rate, Total Customers, Revenue at Risk (Inactive Members) — built as DAX measures on the raw customer/account tables, so they dynamically update based on the country slicer.
...
**Interactivity:** a country slicer (France / Germany / Spain) filters the KPI cards and detail charts dynamically, letting a viewer drill into any single market's churn profile.

## Tools

Python (pandas, numpy, scikit-learn, matplotlib, xgboost) · SQL Server (SSMS) · Power BI Desktop
